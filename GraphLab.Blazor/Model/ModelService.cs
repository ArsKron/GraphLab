...
namespace GraphLab.Blazor.Model
{
    ...
    public class ModelService
    {
        ...
        public void GenerateEulerianFraph()
        {
            ...
            Graph.CreateNeorEdge(allVertex[6], allVertex[3], 1);
            Graph.CreateNeorEdge(allVertex[4], allVertex[6], 1);
            Graph.CreateNeorEdge(allVertex[7], allVertex[5], 1);
            Graph.CreateNeorEdge(allVertex[0], allVertex[7], 1);
            Graph.CreateNeorEdge(allVertex[6], allVertex[7], 1);
            Graph.CreateNeorEdge(allVertex[3], allVertex[7], 1);
            Graph.CreateNeorEdge(allVertex[5], allVertex[6], 1);
        }
