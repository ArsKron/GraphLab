...
namespace GraphLab.Core.Algorithms.Search.FindMinPpannTrees
{
    public class KruskalAlgorithm<TVertex, TEdge>
        ...
        where TEdge : IEdge<TVertex>, new()
    {
        ...
        public KruskalAlgorithm(Graph<TVertex, TEdge> graph)
        {
            Graph = graph;
